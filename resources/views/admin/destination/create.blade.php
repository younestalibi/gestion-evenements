                        ...
                        <form action="{{ route('admin.destination.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 mb-3">
                                    ...
                                    <textarea name="description" id="description" class="form-control @error('description') is-invalid @enderror" placeholder="Description of destination" style="max-height:120px; height: 100px">{{ old('description') }}</textarea>
                                    @error('description')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 mb-3">
                                    ...
                                    <textarea name="places" id="places" class="form-control @error('places') is-invalid @enderror" placeholder="Enter places, separated by commas" style="height: 100px">{{ old('places') }}</textarea>
                                    @error('places')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
